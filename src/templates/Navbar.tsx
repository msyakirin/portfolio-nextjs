...
export default function Navbar() {
  ...
  return (
    <div className="fixed shadow-md w-full h-14 border-b border-[#535353] bg-white z-10 dark-light-mode">
      <div className="flex h-full items-center mx-10 justify-between max-md:mx-4">
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <div className="hidden max-md:block">
            <button
              ...
              className="items-center justify-center p-2 rounded-md focus:outline-none dark-light-mode-open-menu"
        ...
        <style jsx global>{`
          ...
          .text-outline-transparent:hover {
            ...
            -webkit-text-stroke: 0.8px ${darkMode ? "white" : "#00000080"};
          }
